...
/*
    ...
    $result_slike = mysqli_query($link, $sqle);
    $row_slike = mysqli_fetch_array($result_slike);
    $a = mysqli_num_rows($result_slike);

    if ($a == 0) {
    ?><img src="https://upload.wikimedia.org/wikipedia/commons/d/d1/Image_not_available.png" alt="no available"></div><?php
} else {
    //echo '<img src="'.$row_slike['URL'].'" alt="'.$row_slike['opis_s'].'"></div><br>';
}
